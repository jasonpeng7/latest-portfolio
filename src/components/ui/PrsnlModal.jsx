        ...
        <div className="px-6 sm:px-8 overflow-y-auto flex-1 w-full">
          <div className="max-w-[800px] mx-auto py-4 space-y-6">
            ...
            <section className="space-y-4 ">
              ...
              <div className="self-center max-w-[450px]">
            ...
            <section className="space-y-4">
              ...
              <ul className="list-inside space-y-2">
                ...
                <li className="flex items-start">
                  <span className="mr-2  text-sm text-purple-500">•</span>
                  <span className="text-sm text-gray-700">
                ...
                <li className="flex items-start">
                  <span className="mr-2  text-sm text-pink-500">•</span>
                  <span className="text-sm text-gray-700">
