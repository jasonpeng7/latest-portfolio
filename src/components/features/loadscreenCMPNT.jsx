...
const StackedLoadingOverlay = () => {
  ...
  const createLayerPaths = (xOffset = 0, yOffset = 0) => [
    {
      ...
      path: `M ${50.003 + xOffset} ${44.392 + yOffset} L ${65.233 + xOffset} ${
        53.181 + yOffset
      } L ${50.003 + xOffset} ${61.969 + yOffset} L ${34.769 + xOffset} ${
        53.181 + yOffset
      } L ${50.003 + xOffset} ${44.392 + yOffset}`,
      baseRotation: 0,
    },
    {
      id: `right-${xOffset}-${yOffset}`,
      path: `M ${65.72 + xOffset} ${71.586 + yOffset} L ${50.503 + xOffset} ${
        80.429 + yOffset
      } L ${50.503 + xOffset} ${62.834 + yOffset} L ${65.733 + xOffset} ${
        54.046 + yOffset
      } L ${65.72 + xOffset} ${71.586 + yOffset}`,
      baseRotation: 0,
    },
    {
      id: `bottom-${xOffset}-${yOffset}`,
      path: `M ${49.503 + xOffset} ${80.429 + yOffset} L ${34.269 + xOffset} ${
        71.623 + yOffset
      } L ${34.269 + xOffset} ${54.046 + yOffset} L ${49.503 + xOffset} ${
        62.834 + yOffset
      } L ${49.503 + xOffset} ${80.429 + yOffset}`,
      baseRotation: 0,
    },
  ];
  ...
  const layers = [
    ...
    createLayerPaths(
      ...
      VERTICAL_OFFSET * 2 + EXTRA_VERTICAL_OFFSET
    ), // Bottom left
  ...
  return (
    isLoading && (
      <div
        className={`z-50 fixed top-0 left-0 w-full h-full bg-[rgb(220,225,239)] flex items-center justify-center ${
          fadeOut ? "fade-out" : ""
        }`}
      >
            ...
            {layers.map((layer, layerIndex) => (
              <g
                ...
                className={`transition-opacity duration-200 ${
                  layerIndex === 3 ? "opacity-100" : "opacity-80"
                }`}
              >
